          ...
          <div className="col-md-7">
            ...
            <div className="shiping-details">
              ...
              <div className="input-checkbox">
                ...
                <label html-for="shiping-address">
                  <span></span>
